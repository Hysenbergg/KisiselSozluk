...
import 'package:flutter_application_1/screens/gorevekle.dart';
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
            .collection("Gorevler")
            .doc(mevcutkullaniciUidTutucu).collection("Gorevlerim")
            .snapshots(),    // StreamBuilder tarafından cekilen verilerin rahatlıkla görebilmemiz olan gerekn method.
          builder: (context, AsyncSnapshot<QuerySnapshot> veriTabanindanGelenVeriler){
            if(veriTabanindanGelenVeriler.connectionState == ConnectionState.waiting){
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index){                // Burasi ayni zamanda for dongusu
